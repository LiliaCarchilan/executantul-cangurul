...
{
	Blockly.prompt( "Salvare fișier", '', doSaveFile, "Introdu numele fișierului", {} );
}
...
function checkBorderAheadForState(pos, direction, steps) {
  ...
  return px < 0 || px > MAZE_WIDTH || py < 0 || py > MAZE_HEIGHT;
}
...
'<span style="color:#666;font-size:14px;">Model didactic inspirat din manual</span>' +
'</td></tr></table>' +
...
'   <img id="upload" src="./Media/open.gif" title="Deschide un program salvat">' +
'   <input type="file" id="file-load" style="display:none;" onclick="this.value=null;" onchange="loadProgramFromDisk();"></label>' +
'   <img id="save" src="./Media/save.gif" title="Salveaza programul in format XML" style="cursor: pointer;position:relative;top:6px;margin-right:5px;" onclick="saveProgramToDisk();" />' +
